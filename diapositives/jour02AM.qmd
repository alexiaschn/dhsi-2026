...
- Qui connaît un langage de programmation?
    - Qui connaît Python?
- Qui a un corpus de textes sur lesquels iels aimeraient expérimenter?
...
Le nettoyage des données textuelles et des métadonnées est une étape centrale de toute tâche en traitement automatique de la langue\ : des données de qualité sont nécessaires pour obtenir des résultats de qualité. En fouille de données comme en apprentissage profond, la sagesse nous dit "**SH*T IN, SH*T OUT**". 
